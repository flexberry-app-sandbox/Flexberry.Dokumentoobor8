...
namespace IIS.Dokumentoobor8
{
    ...
    public class ТЧПрава : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dokumentoobor8.ПраваПол fПраваПол;
        ...
        public virtual IIS.Dokumentoobor8.ПраваПол ПраваПол
        {
            get
            {
                ...
                IIS.Dokumentoobor8.ПраваПол result = this.fПраваПол;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Dokumentoobor8.АвПользователи.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧПраваE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧПраваE", typeof(IIS.Dokumentoobor8.ТЧПрава));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧПрава : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Dokumentoobor8.DetailArrayOfТЧПрава members)

        // *** End programmer edit section *** (IIS.Dokumentoobor8.DetailArrayOfТЧПрава members)
        ...
        /// </summary>
        public DetailArrayOfТЧПрава(IIS.Dokumentoobor8.АвПользователи fАвПользователи) : 
                base(typeof(ТЧПрава), ((ICSSoft.STORMNET.DataObject)(fАвПользователи)))
        {
        }
        
        public IIS.Dokumentoobor8.ТЧПрава this[int index]
        {
            get
            {
                return ((IIS.Dokumentoobor8.ТЧПрава)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Dokumentoobor8.ТЧПрава dataobject)
        {
