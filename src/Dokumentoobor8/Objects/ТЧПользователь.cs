...
namespace IIS.Dokumentoobor8
{
    ...
    public class ТЧПользователь : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dokumentoobor8.ВходВСистему fВходВСистему;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Dokumentoobor8.ВходВСистему.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ВходВСистему"})]
        public virtual IIS.Dokumentoobor8.ВходВСистему ВходВСистему
        {
            get
            {
                ...
                IIS.Dokumentoobor8.ВходВСистему result = this.fВходВСистему;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧПользовательE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧПользовательE", typeof(IIS.Dokumentoobor8.ТЧПользователь));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧПользователь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Dokumentoobor8.DetailArrayOfТЧПользователь members)

        // *** End programmer edit section *** (IIS.Dokumentoobor8.DetailArrayOfТЧПользователь members)
        ...
        /// </summary>
        public DetailArrayOfТЧПользователь(IIS.Dokumentoobor8.ВходВСистему fВходВСистему) : 
                base(typeof(ТЧПользователь), ((ICSSoft.STORMNET.DataObject)(fВходВСистему)))
        {
        }
        
        public IIS.Dokumentoobor8.ТЧПользователь this[int index]
        {
            get
            {
                return ((IIS.Dokumentoobor8.ТЧПользователь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Dokumentoobor8.ТЧПользователь dataobject)
        {
