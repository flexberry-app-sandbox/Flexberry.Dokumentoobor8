...
moduleForModel('i-i-s-dokumentoobor8-утверждение-док', 'Unit | Serializer | i-i-s-dokumentoobor8-утверждение-док', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentoobor8-утверждение-док',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
