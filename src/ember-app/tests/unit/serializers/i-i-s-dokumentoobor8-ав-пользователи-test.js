...
moduleForModel('i-i-s-dokumentoobor8-ав-пользователи', 'Unit | Serializer | i-i-s-dokumentoobor8-ав-пользователи', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentoobor8-ав-пользователи',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
