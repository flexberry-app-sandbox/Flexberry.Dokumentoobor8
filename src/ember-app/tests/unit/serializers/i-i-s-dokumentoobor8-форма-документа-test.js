...
moduleForModel('i-i-s-dokumentoobor8-форма-документа', 'Unit | Serializer | i-i-s-dokumentoobor8-форма-документа', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentoobor8-форма-документа',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
