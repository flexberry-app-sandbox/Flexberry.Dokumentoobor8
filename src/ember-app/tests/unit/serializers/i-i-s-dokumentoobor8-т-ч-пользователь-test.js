...
moduleForModel('i-i-s-dokumentoobor8-т-ч-пользователь', 'Unit | Serializer | i-i-s-dokumentoobor8-т-ч-пользователь', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentoobor8-т-ч-пользователь',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
